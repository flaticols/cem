...
export class Analyzer {
  ...
  private visitGetAccessor(
    ...
    const existing = classInfo.members.find((m) => m.kind === "field" && m.name === name);
  ...
  private resolveClassInheritance(classInfo: ClassInfo, visited: Set<string>): void {
  ...
  private extractJSDocTags(jsDoc: ReturnType<typeof this.getJSDoc>, classInfo: ClassInfo): void {
    // @fires / @event
  ...
  private getPropertyName(node: ts.PropertyName, sourceFile: ts.SourceFile): string | undefined {
